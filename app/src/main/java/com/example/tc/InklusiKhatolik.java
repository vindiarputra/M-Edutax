...
public class InklusiKhatolik extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inklusi_khatolik);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.button1:
                i = new Intent(this, SapKhatolik.class);
                startActivity(i);
                break;

            case R.id.button2:
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://drive.google.com/file/d/1-3cwggEXPIlsrUAjCJEQX1SGzQcQ8E3d/view?usp=sharing"));
                startActivity(browserIntent);
                break;

            case R.id.button3:
                i = new Intent(this, VideoKhatolik.class);
                startActivity(i);
                break;

            case R.id.button4:
                i = new Intent(this, PenugasanKhatolik.class);
                startActivity(i);
                break;
        }
    }
