...
public class InklusiKristen extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inklusi_kristen);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.button1:
                i = new Intent(this, SapKristen.class);
                startActivity(i);
                break;

            case R.id.button2:
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://drive.google.com/file/d/1m1Ywd-1_ZehIWb1K8oTaYp0HdXT9pvb5/view?usp=sharing"));
                startActivity(browserIntent);
                break;

            case R.id.button3:
                i = new Intent(this, VideoKristen.class);
                startActivity(i);
                break;

            case R.id.button4:
                i = new Intent(this, PenugasanKristen.class);
                startActivity(i);
                break;
        }
    }
