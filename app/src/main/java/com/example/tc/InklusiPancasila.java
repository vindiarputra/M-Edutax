...
public class InklusiPancasila extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inklusi_pancasila);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.button1:
                i = new Intent(this, SapPancasila.class);
                startActivity(i);
                break;

            case R.id.button2:
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://drive.google.com/file/d/1N1H95AXN83N6HeyGE-QyhsXNuCJPMO2J/view?usp=sharing"));
                startActivity(browserIntent);
                break;

            case R.id.button3:
                i = new Intent(this, VideoPancasila.class);
                startActivity(i);
                break;

            case R.id.button4:
                i = new Intent(this, PenugasanPancasila.class);
                startActivity(i);
                break;
        }
    }
