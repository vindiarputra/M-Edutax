...
public class InklusiBahasaindonesia extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inklusi_bahasaindonesia);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.button1:
                i = new Intent(this, SapBahasaindonesia.class);
                startActivity(i);
                break;
            ...
            case R.id.button2:
                ...
                break;
                /*i = new Intent(this, MateriBahasaindonesia.class);
                startActivity(i);
                break;*/

            case R.id.button3:
                i = new Intent(this, VideoBahasaindonesia.class);
                startActivity(i);
                break;

            case R.id.button4:
                i = new Intent(this, PenugasanBahasaindonesia.class);
                startActivity(i);
                break;
        }
